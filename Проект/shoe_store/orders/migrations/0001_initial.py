    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('male', 'Мужская обувь'), ('female', 'Женская обувь')], max_length=100, verbose_name='Категория товара')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Новый'), ('completed', 'Завершён')], default='new', max_length=20, verbose_name='Статус заказа')),
